...
* **Neutral** – not controlled by a single platform
* **Fast** – disputes resolved in minutes, not days
...
Anyone can participate as a juror by staking the required token.

As a juror, you:

* Receive disputes while online
* Review clear case summaries
* Vote privately
* Earn rewards for voting with the majority
* Risk penalties for incorrect or missed votes

The system rewards honest judgment and active participation.
...
* Every ruling is verifiable on-chain

This keeps decisions fair without adding unnecessary complexity.

---

## A Game-Like Experience (With Real Stakes)

Jurors interact through a clean, gamified app:

* Dispute matchmaking
* Timers and notifications
* XP, levels, and reputation
* Token rewards and penalties
* Optional dispute categories

Each dispute is a round.
Your vote is your move.
Predict the majority, earn rewards.
